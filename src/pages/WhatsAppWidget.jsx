    ...
    <>
      ...
      <style>{`
        ...
        .wa-modal-header {
          ...
          font-weight: 700; font-size: 1.13rem; color: #1e1e1e;
        }
        .wa-modal-header span { margin-left: 8px; flex: 1; }
        .wa-modal-close {
          background: none; border: none; font-size: 2rem;
          font-weight: 600; color: #7a563a; cursor: pointer;
        ...
        .wa-label {
          font-size: 1rem; color: #7a563a; margin: 2px 0 1px 2px; font-weight: 600;
        }
        .wa-input {
        ...
        .wa-chat-btn {
          margin-top: 10px; padding: 11px 0; background: #25d366;
